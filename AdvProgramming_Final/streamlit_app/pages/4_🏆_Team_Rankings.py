...
rankings_data = {
    ...
    'Logistic': [3, 5, 4, 1, 2, 18, 12, 10, 16, 6, 12, 19, 11, 14, 17, 16, 20, 28, 7, 21, 9, 22, 24, 26, 8, 20, 23, 29,
                 25, 30, 31, 32],
    'RandomForest': [5, 3, 2, 4, 1, 13, 10, 12, 16, 6, 14, 20, 8, 14, 22, 7, 18, 26, 9, 21, 15, 23, 29, 27, 10, 24, 25,
                     28, 25, 31, 32, 30],
    'KNN': [10, 5, 1, 7, 2, 19, 13, 20, 21, 29, 11, 14, 12, 15, 27, 4, 17, 15, 3, 22, 18, 8, 24, 28, 8, 23, 24, 16, 26,
            30, 29, 32]
}
...
tab1, tab2, tab3, tab4 = st.tabs(
    ["📊 Rankings Comparison", "🎯 Biggest Surprises", "📈 Visual Analysis", "🏅 Model Performance"])
...
with tab2:
    ...
    model_to_col = {
        'Logistic': 'LR_Diff',
        'RandomForest': 'RF_Diff',
        'KNN': 'KNN_Diff'
    }

    diff_col = model_to_col[model_select]
...
with tab3:
    ...
    fig2.update_yaxes(range=[0, 33], dtick=5)
...
st.markdown("---")
st.caption(
    "💡 **Key Insight**: Random Forest's ensemble approach produces better-calibrated team strength estimates, making it superior for rankings despite slightly lower game accuracy.")